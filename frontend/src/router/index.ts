...
const router = createRouter({ history: createWebHistory(), routes: [
  ...
  { path: "/", component: () => import("@/layouts/MainLayout.vue"), children: [
    ...
    { path: "inventory/inbound/new", component: () => import("@/views/inventory/StockMoveForm.vue"), props: { mode: "inbound" }, meta: { title: "新建入库", permission: "stock.write" } },
    { path: "inventory/inbound/:id", component: () => import("@/views/inventory/StockMoveDetail.vue"), props: { mode: "inbound" }, meta: { title: "入库详情", permission: "stock.read" } },
    { path: "inventory/inbound", component: () => import("@/views/inventory/StockMoveList.vue"), props: { mode: "inbound" }, meta: { title: "入库", permission: "stock.read" } },
    { path: "inventory/outbound/new", component: () => import("@/views/inventory/StockMoveForm.vue"), props: { mode: "outbound" }, meta: { title: "新建出库", permission: "stock.write" } },
    { path: "inventory/outbound/:id", component: () => import("@/views/inventory/StockMoveDetail.vue"), props: { mode: "outbound" }, meta: { title: "出库详情", permission: "stock.read" } },
    { path: "inventory/outbound", component: () => import("@/views/inventory/StockMoveList.vue"), props: { mode: "outbound" }, meta: { title: "出库", permission: "stock.read" } },
    ...
    { path: "purchase-orders/:id/edit", component: () => import("@/views/purchase/PurchaseOrderForm.vue"), meta: { title: "编辑采购订单", permission: "order.write" } },
    ...
    { path: "sales-orders/:id/edit", component: () => import("@/views/sales/SalesOrderForm.vue"), meta: { title: "编辑销售订单", permission: "order.write" } },
