...
import { customerApi, Customer, CustomerFilter } from '../api/customerApi';
...
export default function CustomerListPage() {
  ...
  const [filter, setFilter] = useState<CustomerFilter>(defaultFilter);
      ...
      render: (_, r) => (
        <Space size="small">
          <Button
            ...
            size="small"
            icon={<EditOutlined />}
            onClick={() => navigate(`/sales/customers/${r.id}/edit`)}
          >
            编辑
          </Button>
          <Popconfirm
  ...
  return (
    <Card title="客户管理" styles={{ body: { padding: 16 } }}>
