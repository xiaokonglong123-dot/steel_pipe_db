...
│  useContracts(queryKey: ['contracts', filters])             │
│  ...                                                         │
└─────────────────────────────────────────────────────────────┘
```
...
// Pipe change → invalidate ['seamless_pipes'], ['screen_pipes']
// Inbound op  → invalidate ['inbound'], ['inventory']
// Outbound op → invalidate ['outbound'], ['inventory']
```
